...
class Data:
    ...
    def prepare_data(self, num_col: list = None, cat_col: list = None):
        ...
        self.processor = dp.DataProcessor(seq_lenght=self.seq_len, num_columns=num_col, cat_columns=cat_col).fit(self.data[num_col].values, self.data[cat_col].values)
    ...
    def save(self, path: str):
        self.processor.save_metadata(path=path)
        return self